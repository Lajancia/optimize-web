...
function zeroPad(value: number, len: number) {
  ...
  return (
    <div className={style.Article}>
      <div className={style.Article__summary}>
        <div className={style.Article__summary__title}>{props.title}</div>
        <div className={style.Article__summary__desc}>
          {removeSpecialCharacter(props.content)}
        </div>
        <div className={style.Article__summary__etc}>
      ...
      <div className={style.Article__thumbnail}>
        <img
          src={
            props.image +
